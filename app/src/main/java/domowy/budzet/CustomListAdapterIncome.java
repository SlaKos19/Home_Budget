...
public class CustomListAdapterIncome extends ArrayAdapter {
    ...
    public CustomListAdapterIncome(Activity context, String[] categoryNameArrayParam, Double[] balanceValueArrayParam){
        super(context, R.layout.single_item_listview_report_income, categoryNameArrayParam);
    ...
    public View getView(int position, View view, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.single_item_listview_report_income, null, true);
